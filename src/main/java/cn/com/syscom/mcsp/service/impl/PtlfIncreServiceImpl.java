...
import cn.com.syscom.mcsp.service.PTLFIncreService;
import cn.com.syscom.mcsp.service.PtlfService;
import cn.com.syscom.mysql.mapper.PTLFIncreMapper;
...
@Service
public class PtlfIncreServiceImpl implements PTLFIncreService{
	private Logger logger = LoggerFactory.getLogger(PtlfIncreServiceImpl.class);
	private InetAddress iaAddress;
	
	public PtlfIncreServiceImpl() {
		try {
	...
	@Autowired
	private PTLFIncreMapper ptlfIncreMapper;
	
	@Override
	public long countByExample(PTLFIncreExample example) {
		// TODO Auto-generated method stub
		return 0;
	}

	@Override
	public int deleteByExample(PTLFIncreExample example) {
		// TODO Auto-generated method stub
		return 0;
	}

	@Override
	public int deleteByPrimaryKey(Integer primaryId) {
		// TODO Auto-generated method stub
		return 0;
	}
	...
	@Override
	public int insertSelective(PTLFIncre record) {
		// TODO Auto-generated method stub
		return 0;
	}

	@Override
	public List<PTLFIncre> selectByExample(PTLFIncreExample example) {
		// TODO Auto-generated method stub
		return null;
	}

	@Override
	public PTLFIncre selectByPrimaryKey(Integer primaryId) {
		// TODO Auto-generated method stub
		return null;
	}

	@Override
	public int updateByExampleSelective(PTLFIncre record, PTLFIncreExample example) {

		try {
			ptlfIncreMapper.updateByExampleSelective(record, example);
		} catch (Exception e) {
	...
	@Override
	public int updateByExample(PTLFIncre record, PTLFIncreExample example) {
		// TODO Auto-generated method stub
		return 0;
	}

	@Override
	public int updateByPrimaryKeySelective(PTLFIncre record) {
		// TODO Auto-generated method stub
		return 0;
	}

	@Override
	public int updateByPrimaryKey(PTLFIncre record) {
		// TODO Auto-generated method stub
		return 0;
	}
...
/*		if (isoMessageVisa.isTimeOutTrans()) {
		...
		try {
			ptlf.setHostname(iaAddress.getHostName());
			ptlfIncreMapper.insert(ptlf);
			
		} catch (Exception e) {
			logger.error(MessageTemplate.MSG_DAT_FAIL_LOG + "CARD_NUM:{}数据库写入错误{}",ptlf.getCardNum(),e);
			return 0;
		}
